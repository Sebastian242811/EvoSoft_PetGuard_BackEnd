        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
           ...
           //Client Entity
            ...
            builder.Entity<Client>().HasData
                ...
                new Client { Id = 102, FirstName = " second Example FirstName", LastName = "second Example LastName", Email = "example2@email.com", Birthday = Convert.ToDateTime("02/02/2000"), Password = "123456" }
                );
